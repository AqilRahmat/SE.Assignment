...
class Login(ctk.CTkFrame):
    ...
    def login_frame(self):
        ...
        ctk.CTkLabel(register_frame, text="Sign in to your account", text_color="#7E7E7E", font=("Arial Bold", 12)).place(relx=0.5, y=85, anchor="center")

        # IC input
        ctk.CTkLabel(register_frame, text="  IC", text_color="#4A4E69", font=("Arial Bold", 14), image=ic_icon, compound="left").place(relx=0.5, y=150, anchor="center")
        ...
        # Password Input
        ctk.CTkLabel(register_frame, text="  Password", text_color="#4A4E69", font=("Arial Bold", 14), image=password_icon, compound="left").place(relx=0.5, y=230, anchor="center")
        ...
        # Login Button
        ctk.CTkButton(register_frame, text="Login", command=lambda: self.validate_login(), fg_color="#A2D2FF", hover_color="#BDE0FE", font=("Arial Bold", 12), text_color="#4A4E69", width=225).place(relx=0.5, y=320, anchor="center")

...
class Register(ctk.CTkFrame):
    ...
    def register_new_account(self):
        ...
        ctk.CTkLabel(register_frame, text="  Phone Number", text_color="#601E88", font=("Arial Bold", 14),
                     image=email_icon, compound="left").place(relx=0.5, y=310, anchor="center")
        ctk.CTkEntry(register_frame, width=225, fg_color="#EEEEEE", border_color="#601E88",
                     border_width=1, text_color="#000000").place(relx=0.5, y=340, anchor="center")

        # Login Button
        ctk.CTkButton(register_frame, text="Register", fg_color="#601E88", hover_color="#E44982",
                      font=("Arial Bold", 12), text_color="#ffffff", width=225).place(relx=0.5, y=420, anchor="center")
        ...
        ctk.CTkButton(register_frame, text="Exit", command=lambda: self.controller.show_frame("Login"), fg_color="#EEEEEE", hover_color="#E44982",
                      font=("Arial Bold", 9), text_color="#601E88", width=225).place(relx=0.5, y=470, anchor="center")
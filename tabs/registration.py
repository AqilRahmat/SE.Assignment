...
class Register(ctk.CTkFrame):
    ...
    def register_new_account(self):
        ...
        # Name Input
        ctk.CTkLabel(register_frame, text="  Name", text_color="#601E88", font=("Arial Bold", 14),
                     image=name_icon, compound="left").place(relx=0.5, y=150, anchor="center")
        self.nameinput_field = ctk.CTkEntry(register_frame, width=225, fg_color="#EEEEEE", border_color="#601E88",
                     border_width=1, text_color="#000000")
        self.nameinput_field.place(relx=0.5, y=180, anchor="center")

        # IC Input
        ctk.CTkLabel(register_frame, text="  I/C", text_color="#601E88", font=("Arial Bold", 14),
                     image=ic_icon, compound="left").place(relx=0.5, y=230, anchor="center")
        ...
        ctk.CTkLabel(register_frame, text="  Username", text_color="#601E88", font=("Arial Bold", 14),
                     image=username_icon, compound="left").place(relx=0.5, y=310, anchor="center")
        self.usernameinput_field = ctk.CTkEntry(register_frame, width=225, fg_color="#EEEEEE", border_color="#601E88",
                     border_width=1, text_color="#000000")
        ...
        ctk.CTkLabel(register_frame, text="  Password", text_color="#601E88", font=("Arial Bold", 14),
                     image=password_icon, compound="left").place(relx=0.5, y=390, anchor="center")
        ...
        # Phone Number Input
        ctk.CTkLabel(register_frame, text="  Phone Number", text_color="#601E88", font=("Arial Bold", 14),
                     image=phone_icon, compound="left").place(relx=0.5, y=470, anchor="center")
        self.phoneinput_field = ctk.CTkEntry(register_frame, width=225, fg_color="#EEEEEE", border_color="#601E88",
                     border_width=1, text_color="#000000")
        self.phoneinput_field.place(relx=0.5, y=500, anchor="center")

        # Register Button
        ctk.CTkButton(register_frame, text="Register", fg_color="#601E88", hover_color="#E44982",
                      font=("Arial Bold", 12), text_color="#ffffff", width=225,
                      command=lambda: self.validate_inserted()).place(relx=0.5, y=560, anchor="center")

        # Exit Button
        ctk.CTkButton(register_frame, text="Exit", command=lambda: self.controller.show_frame("Login"), fg_color="#EEEEEE", hover_color="#E44982",
                      font=("Arial Bold", 9), text_color="#601E88", width=225).place(relx=0.5, y=600, anchor="center")

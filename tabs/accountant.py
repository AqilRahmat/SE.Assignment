...
import dbfunction
import navbar
from dbfunction import fetch_entry
...
class Account(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.tree = ttk.Treeview(table_frame, columns=("FeeID", "DueDate", "Amount", "Status", "CreatedTime"), show="headings")
        ...
        self.status_label.grid(row=2, column=2, padx=10, pady=5, sticky="e")
        ...
        self.status_menu.grid(row=2, column=3, padx=10, pady=5, sticky="w")
    ...
    def populate_tree(self):
        ...
        cursor = conn.cursor()
        cursor.execute("SELECT feerecord_id, feerecord_duedate, feerecord_amount, feerecord_status, feerecord_timecreated FROM feerecord")
    ...
    def add_fee(self):
        ...
        dbfunction.insert_into_feerecorddatabase(fee_id, amount, status)
